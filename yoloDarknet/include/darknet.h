...
typedef struct network {
  ...
  float min_ratio;
  int center;
  int flip; // horizontal flip 50% probability augmentaiont for classifier training
            // (default = 1)
  int gaussian_noise;
  int blur;
  int mixup;
...
LIB_API void diounms_sort(detection* dets,
                          int total,
                          int classes,
                          float thresh,
                          NMS_KIND nms_kind,
...
LIB_API detection* get_network_boxes(network* net,
                                     int w,
                                     int h,
                                     float thresh,
                                     float hier,
                                     ...
                                     int* num,
                                     int letter);
LIB_API det_num_pair* network_predict_batch(network* net,
                                            image im,
                                            int batch_size,
                                            int w,
                                            int h,
...
LIB_API char* detection_to_json(detection* dets,
                                int nboxes,
                                int classes,
                                char** names,
...
// LIB_API detection *get_network_boxes(network *net, int w, int h, float thresh, float
// hier, int *map, int relative, int *num, int letter);
...
LIB_API float validate_detector_map(char* datacfg,
                                    char* cfgfile,
                                    char* weightfile,
...
LIB_API void train_detector(char* datacfg,
                            char* cfgfile,
                            char* weightfile,
                            int* gpus,
                            int ngpus,
                            ...
                            char* chart_path,
                            int mAP_epochs);
LIB_API void test_detector(char* datacfg,
                           char* cfgfile,
                           char* weightfile,
                           char* filename,
                           float thresh,
...
LIB_API void optimize_picture(network* net,
                              image orig,
                              int max_layer,
                              float scale,
                              float rate,
...
LIB_API image make_attention_image(int img_size,
...
LIB_API void set_track_id(detection* new_dets,
                          int new_dets_num,
                          float thresh,
                          float sim_thresh,
                          float track_ciou_norm,
                          ...
                          int dets_for_track,
                          int dets_for_show);
LIB_API int fill_remaining_id(detection* new_dets,
                              int new_dets_num,
                              int new_track_id,
                              float thresh);
