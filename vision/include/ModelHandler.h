...
public:
  ...
  std::vector<std::string> runClassificationOCR(const std::filesystem::path&) const;
  void handleClassificationOCR(const std::filesystem::path&, struct FoodItem&) const;
