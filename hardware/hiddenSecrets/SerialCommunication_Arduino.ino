...
Currently a number x is sent from the Raspberry Pi to the Aruduino. The Arduino acts
accordingly to which number is sent, then sends a "confirmation" back to the Pi.
*/
